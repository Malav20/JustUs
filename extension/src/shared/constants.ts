export const CONFIG = {
  SUPABASE_URL: "https://djuqnhqedykhectfhzba.supabase.co",
  SUPABASE_ANON_KEY:
  ...
  DRIFT_THRESHOLD_SECONDS: 1.5, // 1.5s tolerance for DRM players
  HEARTBEAT_INTERVAL_MS: 3000,  // 3s
  SYNC_ACTION_COOLDOWN_MS: 500, // echo prevention lock window
};
